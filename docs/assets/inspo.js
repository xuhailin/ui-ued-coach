...
const SITES = [
  ...
  },
  {
    ...
    desc: "AI 模型、数据集和 Spaces demo 的开放社区。适合观察模型卡信息结构、AI 产品 demo 呈现和开发者生态入口。",
    tags: ["AI", "模型", "社区"],
    group: "resource",
    colorA: "#ffcc4d",
    colorB: "#7c4a03",
  ...
  },
  {
    id: "017",
    name: "TripoSplat",
    url: "tripo3d.ai/research/triposplat",
    href: "https://www.tripo3d.ai/research/triposplat",
    desc: "单图生成 3D Gaussian Splat 的 AI 研究 demo。适合观察图片到 3D、可交互资产、AI 创作工具如何把模型能力包装成即时体验。",
    tags: ["AI", "3D", "生成"],
    group: "resource",
    colorA: "#34d399",
    colorB: "#2563eb",
